import{R as n}from"./index-RYns6xqu.js";import{O as a}from"./OperationalPoint-im0xeP_S.js";const o=({operationalPoints:t,activeOperationalPointId:i})=>n.createElement("div",{className:"operational-point-list "},t.map(e=>n.createElement("div",{key:e.id,className:"operational-point-wrapper flex flex-col justify-start",style:e.styles},n.createElement(a,{operationalPoint:e,isActive:i===e.id}))));o.__docgenInfo={description:"",methods:[],displayName:"OperationalPointList",props:{operationalPoints:{required:!0,tsType:{name:"Array",elements:[{name:"intersection",raw:`OperationalPointType & {
