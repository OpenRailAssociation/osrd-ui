...
> = ({ bbox, mapStyle, sources, transformedData, backgroundColor = "white", path, pathLayer, log, children }) => {
            ...
            return (
              <Layer
                ...
                {...({
                  ...
                  filter: layer.filter ? ["all", layer.filter, sourceLayerFilter] : sourceLayerFilter,
                } as LayerProps)}
              />
            );
          })}
