...
import WaypointListWithGOV from './WaypointListWithGov';
import type { InteractiveWaypoint, WaypointMenuData } from '../types';

type SplitManchetteWithGOVProps = {
...
export default SplitManchetteWithGOV;
